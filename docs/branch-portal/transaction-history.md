    ...
    <>
      ...
      <div style={s.root}>
        ...
        <div style={s.header}>
          <div style={s.glow1} />
          <div style={s.glow2} />
          <h1 style={s.h1}>Transaction <em style={s.em}>History</em></h1>
          <p style={s.sub}>View and filter all bank transactions with full column detail and lifecycle tracking.</p>
        </div>

        <ImgCard src="/img/BP/history.png" alt="History Table" label="Fig. 1" />

        {/* Transaction History */}
        <div style={s.sectionHeading}>Transaction History <div style={s.line} /></div>
        <div style={s.card}>
          <div style={s.cardTitle}>Transaction List Table with Filters</div>
          <ul style={s.list}>
            <li style={s.item}>
              <span style={s.bullet} />
              <div>
