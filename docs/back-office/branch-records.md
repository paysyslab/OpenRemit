    ...
    <>
      ...
      <div style={s.root}>
        ...
        <div style={s.header}>
          <div style={s.glow1} />
          <div style={s.glow2} />
          <h1 style={s.h1}>Branch <em style={s.em}>Records</em></h1>
          <p style={s.sub}>Manage branch users, bulk uploads, and approval workflows for user creation and updates.</p>
        </div>
        ...
        <div style={s.card}>
          ...
          <ul style={s.list}>
            <li style={s.item}>
              <span style={s.bullet} />
              <div>
                Add new user records with the following details:
                <ul style={s.subList}>
                  {[
                    'Full Name',
            ...
            <li style={s.item}>
              <span style={s.bullet} />
              <div>
                View user details with columns: Full Name, Username, Email, Mobile, Branch Code, Settlement Account, Designation, Currency, Status, Created At, Actions
                <ul style={s.subList}>
                  {['View', 'Edit', 'Sync from Bank', 'Activate / Deactivate', 'Reset Password', 'Password Reset History', 'Audit Log'].map((a, i) => (
                    <li key={i} style={s.subItem}><span style={s.subBullet} />{a}</li>
                  ))}
                </ul>
              </div>
            </li>
        ...
        <ImgCard src="/img/BO/BranchUsers/UM.png" alt="User Management" label="Fig. 1" />
        ...
        <div style={s.card}>
          ...
          <ul style={s.list}>
            <li style={s.item}><span style={s.bullet} />Download sample, upload file, and create users in bulk.</li>
          </ul>
        </div>
        <ImgCard src="/img/BO/BranchUsers/Bulk.png" alt="Bulk Upload" label="Fig. 2" />

        <div style={{ ...s.card, marginTop: 0 }}>
          <ul style={s.list}>
            <li style={s.item}><span style={s.bullet} />View the bulk upload history for up to a month.</li>
          </ul>
        </div>
        <ImgCard src="/img/BO/BranchUsers/BulkList.png" alt="Bulk Upload List" label="Fig. 3" />

        {/* Maker Inbox */}
        <div style={s.sectionHeading}>Maker Inbox <div style={s.line} /></div>
        <div style={s.card}>
          <div style={s.cardTitle}>Maker Inbox</div>
          <ul style={s.list}>
            <li style={s.item}><span style={s.bullet} />View and edit user creation requests, update/remove requests, single-user and bulk creation/edit requests.</li>
          </ul>
        </div>
        <ImgCard src="/img/BO/BranchUsers/makerinbox.png" alt="Maker Inbox" label="Fig. 4" />
        ...
        <div style={s.card}>
          ...
          <ul style={s.list}>
            <li style={s.item}><span style={s.bullet} />Approve or reject user creation with reason required.</li>
          </ul>
        </div>
